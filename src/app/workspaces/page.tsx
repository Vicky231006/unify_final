...
const existingWorkspaces = [
    { id: 1, name: "Acme Corp Global", role: "Manager", lastActive: "2 hours ago", color: "from-blue-500 to-indigo-500" },
    { id: 2, name: "Stark Industries", role: "CEO", lastActive: "Yesterday", color: "from-red-500 to-orange-500" },
    { id: 3, name: "Wayne Enterprises", role: "Employee", lastActive: "3 days ago", color: "from-emerald-500 to-teal-500" },
];
                        ...
                        <Link key={ws.id} href="/dashboard">
                            ...
                            >
                                ...
                                <div className="mt-auto flex items-center justify-between text-xs text-gray-500 border-t border-[var(--color-border)] pt-4">
                                    <span>Last active: {ws.lastActive}</span>
